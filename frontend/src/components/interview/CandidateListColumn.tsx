...
import { Search, Filter, Check, CheckCircle2, Clock } from "lucide-react";
                        ...
                        return (
                            ...
                            >
                                ...
                                <div className="min-w-0 flex-1">
                                    ...
                                    {existingIv ? (
                                        <div className="flex items-center justify-between gap-1 mt-1.5 pt-1.5 border-t border-slate-100/80">
                                            <span className="inline-flex items-center gap-1 text-[11px] font-bold text-emerald-600 truncate">
